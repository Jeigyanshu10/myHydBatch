package com.te.myplayerapp.controllers;
...
import com.te.myplayerapp.dto.PlayerResponse;
import com.te.myplayerapp.service.PlayerService;
...
public class PlayerController {
	...
	public PlayerResponse addPlayer(@RequestBody Player player) {
		...
		if(service.insertPlayer(player)!=null) {
	...
	public PlayerResponse updatePlayer(@RequestBody Player player) {
		...
		if(service.updatePlayer(player)!=null) {
			response.setStatusCode(200);
			response.setMsg("successful");
